<div class="box box-primary">
  ...
  <!-- form start -->
  <form name="form" id="form" role="form" method="post" action="<?php echo base_url('type_dokumen/aksi_tambah/'); ?>">
    <div class="box-body">
    ...
    <div class="box-footer">
      ...
      <a href="<?php echo base_url('type_dokumen'); ?>" class="btn btn-info">Batal</a>
    </div>
  </form>
</div><!-- /.box -->
