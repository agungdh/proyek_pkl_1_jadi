...
<div class="box box-primary">
  <div class="box-header with-border">
    ...
    <div class="form-group">
      ...
      <h5><strong>
        <a href='<?php echo base_url("butirpenilaian"); ?>'>
          <font color=black>
            <u>Butir Penilaian:</u>
          </a>
            <br>
    ...
    <a href='<?php echo base_url("butirpenilaian/tambah/".$data['pengajuan']->id); ?>'><button class="btn btn-success"><i class="fa fa-plus"></i> Penilaian</button></a>
    </div>
    ...
    <table id="lookup" class="table table-striped table-bordered table-hover" cellspacing="0" width="100%">
      ...
      <tbody>
            ...
            foreach ($data['butirpenilaian'] as $item) {
              $jumlah_butir = $this->m_butirpenilaian->ambil_jumlah_butir($data['pengajuan']->versi_id);
              ?>
              <tr>
