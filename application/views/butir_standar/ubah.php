<div class="box box-primary">
  ...
  <!-- form start -->
  <form name="form" id="form" role="form" method="post" action="<?php echo base_url('butir_standar/aksi_ubah'); ?>">
    <div class="box-body">

    <div class="form-group">
      <label for="id_butir">ID Butir</label>
          <input value="<?php echo $data['data_butir_standar']->id_Butir; ?>" readonly required type="text" class="form-control" id="id_butir" placeholder="Isi ID Butir" name="id_butir">          
    </div>

    <div class="form-group">
      <label for="nomor_butir">Nomor Butir</label>
          <input value="<?php echo $data['data_butir_standar']->nomor_butir; ?>" required type="text" class="form-control" id="nomor_butir" placeholder="Isi Nomor Butir" name="nomor_butir">          
    </div>

    <div class="form-group">
      <label for="butir_pertanyaan">Butir Pertanyaan</label>
          <input value="<?php echo $data['data_butir_standar']->butir_pertanyaan; ?>" required type="text" class="form-control" id="butir_pertanyaan" placeholder="Isi Butir Pertanyaan" name="butir_pertanyaan">          
    </div>
    ...
    <div class="form-group">
      ...
      <select class="form-control select2" name="id_standar">
        ...
        foreach ($data['standar_borang'] as $item) {
          ...
          ?>
          <option selected value="<?php echo $item->id_standar; ?>"><?php echo $item->id_standar . " | " . $item->nomor_standar . " | " . $item->nama_standar . " | " . $item->id_versi; ?></option>
          <?php
        } else {
          ?>
