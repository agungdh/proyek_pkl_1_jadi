...
<div class="box-header with-border">
    ...
    <br>
      <h5><strong>
        ...
        <br>
        <a href='<?php echo base_url("penilaian/index/" . $data['pengajuan']->id); ?>'>
          <font color=blue>
            <u>Penilaian:</u></a>
          </font><br>
        <?php
            ...
            <tbody>
              ...
              foreach ($this->m_penilaian->ambil_detail($item->id) as $item2) {
                  ...
                  <tr>
                    ...
                    <td>
                      <input type="number" min="0" max="4" step=".01" value="<?php echo $nilai; ?>" name="nilai[<?php echo $item2->id_butir_penilaian; ?>]">
                    </td>
                    <?php echo $lido; ?>
                  </tr>
                  <?php
